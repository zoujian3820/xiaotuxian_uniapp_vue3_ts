...
// 按钮模式，小程序直接用枚举属性值当参传，报错
enum SkuMode {
  Both = 1,
  Cart = 2,
  Buy = 3
}
const SkuModeObj: typeof SkuMode = {
  Both: 1,
  Cart: 2,
  Buy: 3
}

const mode = ref<SkuMode>(SkuModeObj.Cart)
// 打开SKU弹窗修改按钮模式
  ...
  <view class="page-content">
    <scroll-view enable-back-to-top scroll-y class="viewport">
      ...
      <view class="goods">
        ...
        <!-- 操作面板 -->
        <view class="action">
          <view @tap="openSkuPopup(SkuModeObj.Both)" class="item arrow">
    ...
    <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
      ...
      <view class="buttons">
        <view @tap="openSkuPopup(SkuModeObj.Cart)" class="addcart"> 加入购物车 </view>
        <view @tap="openSkuPopup(SkuModeObj.Buy)" class="payment"> 立即购买 </view>
      </view>
    </view>
  </view>
